<?php
   ...
   if(!isset($_SESSION['App_Log_Access'])){
    ...
    require "php_admin_script/edit_book_script.php";
    error_reporting(0);
?>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Edit Booking Data</h3>
              ...
              <div class="card-header p-0 border-bottom-0">
                <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-four-home-tab" data-toggle="pill" href="#custom-tabs-four-home" role="tab" aria-controls="custom-tabs-four-home" aria-selected="true">Booking Information</a>
                  </li>
                </ul>
              </div>
              ...
              <div class="card-body">
                <div class="tab-content" id="custom-tabs-four-tabContent">
                  ...
                  <form action="php_admin_script/edit_book_script_copy.php" method="post">
                          ...
                          <div class="row card-body">
                            ...
                            <div class="form-group col-6">
                              ...
                              <select id="inputStatus" class="form-control" name="status">
                                    ...
                                    <?php $status_script = $mysqli->query("SELECT `status_id`, `status_name` FROM `equipments`.`status`"); 
