<?php
   ...
   if(!isset($_SESSION['App_Log_Access'])){
    ...
    require "php_admin_script/edit_simple_report_script.php";
    error_reporting(0);
?>
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <ol class="breadcrumb ">
                        ...
                        <li class="breadcrumb-item">Report (In-Use)</li>
                        <li class="breadcrumb-item active">Edit Report (In-Use)</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Edit Report Data (In-Use)</h3>
