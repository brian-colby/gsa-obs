...
WHERE CONCAT(request_tbl.name, equipment_tbl.equipment_name, request_tbl.use_date, department_tbl.department_name, status.status_name) LIKE '%".$search."%' 
GROUP BY request_tbl.request_id
ORDER BY request_tbl.request_date DESC LIMIT ?,?";
              
// Getty requested the change:
// CONCAT(request_tbl.name, equipment_tbl.equipment_name, request_tbl.use_date, 
// request_tbl.request_date, department_tbl.department_name, status.status_name)
