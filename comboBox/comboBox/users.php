            ...
            <div class="card">
                  ...
                  <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h4 class="modal-title"><i class="fa fa-edit"> </i> Add New Admin </h4>
                        ...
                        <div class="card card-primary card-outline card-outline-tabs">
						  <div class="card-header p-0 border-bottom-0">
							<ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
							  <li class="nav-item">
								<a class="nav-link active" id="custom-tabs-four-home-tab" data-toggle="pill" href="#custom-tabs-four-home" role="tab" aria-controls="custom-tabs-four-home" aria-selected="true">Admin Information</a>
							  </li>
							</ul>
						  </div>
						  <div class="card-body">
							  ...
							  <form method="post" action="<?=$_SERVER['SCRIPT_NAME'];?>">
									  <div class="row card-body">
                                        <div class="form-group col-4">
                                            ...
                                            <input type="text" class="form-control" name="new-admin-name" id="new-admin-name" required>
                                        </div>
                                        <div class="form-group col-4">
                                            <label for="new-admin-email">Admin Email:</label>
                                            <input type="email" class="form-control" name="new-admin-email" id="new-admin-email" required>
                                        </div>
                                        <div class="form-group col-4">
                                            <label for="new-admin-password">Password:</label>
                                            <input type="password" class="form-control" name="new-admin-password" id="new-admin-password" required>
                                        </div>
									  </div>
							  </div>
                      ...
                      <div class="modal-footer justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary" name="sub_admin">Submit</button>
                      </div>
                    </div>
            </form>
                    <!-- /.modal-content -->
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <?php require "php_admin_script/users_back_script.php";?>
