  ...
  <div class="card card-outline card-info">
    ...
    <div class="card-body">
      ...
      <div class="form-label-group">
		      <label style="color: red"><?php if ($_GET["logFailed"] == 1) {echo 'Woops! Email or Password is Wrong.'; }?></label>
		  </div>
      <form action="comboBox/php_admin_script/loginProcessor.php" method="post">
