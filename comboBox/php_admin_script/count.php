...
####################################################################################################
$projector = $mysqli->query("SELECT * FROM `equipment_tbl` WHERE `equipment_name` = 'Projector'");
    $projector_rows = $projector->num_rows;
	
$laptop = $mysqli->query("SELECT * FROM `equipment_tbl` WHERE `equipment_name` = 'Laptop'");
    $laptop_rows = $laptop->num_rows;
	
$pointer = $mysqli->query("SELECT * FROM `equipment_tbl` WHERE `equipment_name` = 'Pointer'");
    $pointer_rows = $pointer->num_rows;
	
$speaker = $mysqli->query("SELECT * FROM `equipment_tbl` WHERE `equipment_name` = 'Speaker'");
    $speaker_rows = $speaker->num_rows;
####################################################################################################	
